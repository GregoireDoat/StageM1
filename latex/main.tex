...
Pour le voir, dans la figure \textit{\ref{fig:LGDgauss-g}} ci-dessous, les deux premières initialisations, $(1)$ et $(2)$, sont faites avec un vecteur aléatoires tirés suivant une loi uniforme. Les deux suivantes, $(3)$ et $(4)$, le sont suivant des lois normales d'écart-type respectif 1 et 5. 
\\
